...
3) Генерация кандидатов (Best-of-N + RankCoT)
...
4) Оценка кандидатов (HPSS + ансамбль оценщиков)
...
5) Self-refine (итеративное улучшение)
...
6) RAG / Retrieval (если требуется) (SAGE / DeepRAG)
